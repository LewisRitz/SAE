...
{"uid":"14","begins":"2014-01-16 20:45:00","ends":"2014-01-17T02:45:00.000Z","notes":"Eye exam","color":null},
...
function addEvents(newArray){
	for(var i=0;i<newArray.length;i++){
		//elementz[elementz.length+(i+1)] = newArray[i].slice();
		elementz[elementz.length+(i+1)] = {"uid":"69","begins":"2013-12-31 13:00:00","ends":"2013-12-31T21:30:00.000Z","notes":"Walk the dog","color":null};
	}
}
